...
var MessengerCustomerChat = function (_Component) {
  ...
  function MessengerCustomerChat() {
    ...
    return _possibleConstructorReturn(this, (MessengerCustomerChat.__proto__ || Object.getPrototypeOf(MessengerCustomerChat)).apply(this, arguments));
  }
  ...
  _createClass(MessengerCustomerChat, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (prevProps.pageId !== this.props.pageId || prevProps.appId !== this.props.appId || prevProps.htmlRef !== this.props.htmlRef || prevProps.minimized !== this.props.minimized || prevProps.themeColor !== this.props.themeColor || prevProps.loggedInGreeting !== this.props.loggedInGreeting || prevProps.loggedOutGreeting !== this.props.loggedOutGreeting || prevProps.greetingDialogDisplay !== this.props.greetingDialogDisplay || prevProps.greetingDialogDelay !== this.props.greetingDialogDelay || prevProps.autoLogAppEvents !== this.props.autoLogAppEvents || prevProps.xfbml !== this.props.xfbml || prevProps.version !== this.props.version || prevProps.language !== this.props.language || prevProps.debug !== this.props.debug) {
        this.setFbAsyncInit();
        this.reloadSDKAsynchronously();
      }
    }
    ...
    value: function removeFacebookSDK() {
      var fbjssdk = document.getElementById('facebook-jssdk');
      if (fbjssdk) {
