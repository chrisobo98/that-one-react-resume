...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (position === 'left') {
<span class="cstat-no" title="statement not covered" >      className += ' vertical-timeline-element--left';</span>
    }
&nbsp;
    if (position === 'right') {
