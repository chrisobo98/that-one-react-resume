            ...
            {props.introduction.map((intro) =>
                <div className='item' key={intro.introductionTitle}>
                    <p> I am a freelance developer looking for a full-time position at a company with the opportunity for advancement. I have been working in web development for almost two years now. 
                        ...
                        I was not satisfied. <br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;My OCD flared up whenever I saw the site, and the perfectionist in me didn't let me sleep knowing it wasn't as aesthetically pleasing as I wanted it to be. 
                        I went on to delve deeper into the word of web development, finding ways to customize sites how I wanted to, as opposed to being contained by the scarcity of options from themes. I started finding information on HTML5, and websites like W3Schools, Treehouse, freeCodeCamp, Codeacademy and more. 
                        ...
                        I now solely focus and rely on my developer skills, growing and learning something new every day.</p>
                </div>
            )}
        </div>
    );
